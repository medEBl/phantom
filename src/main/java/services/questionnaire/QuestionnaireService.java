...
public class QuestionnaireService implements IQuestionnaireService {
    ...
    public void createQuestionnaire(Questionnaire q) {
        ...
        try (PreparedStatement ps = cnx.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            throw new RuntimeException("createQuestionnaire failed: " + e.getMessage(), e);
        }
    }
    ...
    public List<Questionnaire> getAllQuestionnaires() {
        ...
        try (Statement st = cnx.createStatement(); ResultSet rs = st.executeQuery(sql)) {
            ...
            throw new RuntimeException("getAllQuestionnaires failed: " + e.getMessage(), e);
        }
        return list;
    }
    ...
    public Optional<Questionnaire> getQuestionnaireById(int id) {
        ...
        try (PreparedStatement ps = cnx.prepareStatement(sql)) {
            ...
            throw new RuntimeException("getQuestionnaireById failed: " + e.getMessage(), e);
        }
