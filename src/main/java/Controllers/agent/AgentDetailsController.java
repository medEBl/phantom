...
public class AgentDetailsController {
    ...
    private void navigateBack() {
        try {
            ...
            boolean isAdmin = (btnNavQuestionnaires != null);
            String fxmlPath = isAdmin ? "/agent/fxml/ListAgentsBack.fxml" : "/agent/fxml/ListAgents.fxml";
    ...
    private void openReponseEditScreen() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/agent/fxml/ReponseEdit.fxml"));
            Parent root = loader.load();
