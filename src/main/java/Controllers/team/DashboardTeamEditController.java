...
public class DashboardTeamEditController {
    ...
    private void populateFields() {
        if (currentTeam != null) {
            idField.setText(String.valueOf(currentTeam.getId()));
    ...
    private void updateTeamFromFields() {
        currentTeam.setName(nameField.getText().trim());
        currentTeam.setGame(gameComboBox.getValue());
        currentTeam.setCoachId(coachComboBox.getValue());
    }
