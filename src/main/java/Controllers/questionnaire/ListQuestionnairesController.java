...
public class ListQuestionnairesController {
        ...
        if (btnNavAgents != null) {
            btnNavAgents.setOnAction(e -> {
                try {
                    ...
                    Parent root = FXMLLoader.load(getClass().getResource("/agent/fxml/ListAgentsBack.fxml"));
    ...
    private void openCreate() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/agent/fxml/QuestionnaireCreate.fxml"));
    ...
    private void openDetails(Questionnaire q) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/agent/fxml/QuestionnaireDetails.fxml"));
            Parent root = loader.load();
