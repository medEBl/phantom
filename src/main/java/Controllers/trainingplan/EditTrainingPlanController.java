...
public class EditTrainingPlanController {
    ...
    private void populateFields() {
        ...
        planIdField.setText(String.valueOf(currentPlan.getId()));
        titleField.setText(currentPlan.getTitle() != null ? currentPlan.getTitle() : "");
        descriptionArea.setText(currentPlan.getDescription() != null ? currentPlan.getDescription() : "");
        
        // Set dropdown values
        focusAreaComboBox.setValue(currentPlan.getFocusArea());
        difficultyComboBox.setValue(currentPlan.getDifficultyLevel());
        setCoachById(currentPlan.getCoachId());
        setTeamById(currentPlan.getTeamId());

        // Disable plan ID field
        planIdField.setDisable(true);
    }
    
    private void setCoachById(int coachId) {
    ...
    private void setTeamById(int teamId) {
    ...
    private void handleSave() {
        ...
        try {
            ...
            currentPlan.setCoachId(coachComboBox.getValue().getId());
            currentPlan.setTeamId(teamComboBox.getValue().getId());
