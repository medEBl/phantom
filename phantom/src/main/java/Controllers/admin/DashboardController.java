...
public class DashboardController {
    ...
    private void handleShop() {
        try {
            FXMLLoader shopLoader = new FXMLLoader(getClass().getResource("/admin/fxml/shop-items.fxml"));
            Parent shopRoot = shopLoader.load();
            
            Stage stage = (Stage) navShop.getScene().getWindow();
            Scene scene = new Scene(shopRoot, 1920, 1080);
            stage.setScene(scene);
            stage.setMaximized(true);
            stage.setFullScreen(true);
            ...
            System.err.println("Cannot open shop management: " + e.getMessage());
        }
    }
    ...
    private void handleShopItems() {
        try {
            ...
            System.err.println("Cannot open shop items management: " + e.getMessage());
        }
    }
